...
TRANSLATIONS = {
    ...
    'ar': {
        ...
        'referral_joined': 'المستخدم {username} انضم عبر رابط الإحالة الخاص بك وتمت إضافة 0.1 TON إلى رصیدک. 👏',
...
def main():
    ...
    bot_token = os.getenv('BOT_TOKEN', '7593433447:AAE3N5fBQXKBGeITOAWwo5-ARxD5Q8v5oS4')
